...
public class ClienteDAO {
    ...
    public void insertar(Cliente c) {
        ...
        String sql = "INSERT INTO clientes "
                + "(nombre, apellido, cedula, telefono, direccion, correo_electronico, fecha_nacimiento, contrasena, rol) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection con = ConexionDB.getConexion();
            ...
            System.out.println(">>> LOG DAO: ¡EXITO! Filas insertadas: " + filas);

        } catch (SQLException e) {
            System.out.println(">>> ERROR CRÍTICO EN DAO (INSERT): " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public boolean actualizar(Cliente c) {
        ...
        String sql = "UPDATE clientes SET "
                ...
                + "correo_electronico=?, fecha_nacimiento=?, contrasena=?, rol=? "
                + "WHERE id_cliente=?";
